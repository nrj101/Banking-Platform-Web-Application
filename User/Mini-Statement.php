...
$query="SELECT * FROM `$ac_no` ORDER BY T_No DESC LIMIT 15;";   
	...
	<div id="header" class="w3-container w3-col m12 l12 w3-center">
		...
		<!--Navigation Bar-->
				<div id="navigation" class="w3-bar">
					...
					<a href="Mini-Statement.php" class="w3-bar-item w3-button w3-round-xlarge w3-padding-large w3-red w3-hover-lime">Mini-Statement</a>
