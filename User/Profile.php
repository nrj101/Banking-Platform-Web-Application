...
<?php
	...
	$query3="SELECT * FROM SERVICES WHERE AC_NO='$ac'";  
...
<table title="Account Info." border=4 width="65%" align="center" style="background-color:#010; color:#fff;">
	...
	<tr>
	<td>Photo :</td><td><img src="../Uploads/Photos/<?php echo $info['AC_NO'];?>.jpg" height="100" width="100"></td>
	</tr>
...
{ 
	...
	<tr><td>Debit Card : </td><td><?php if($info3['Debit_Card']!=NULL) echo $info3['Debit_Card']; else echo "Not Applied";?></td></tr>
	<tr><td>Net Banking : </td><td><?php if($info3['NetBanking_ID']!=NULL) echo "Activated"; else echo "Not Applied";?></td></tr>
	<tr><td>Credit Card : </td><td><?php if($info3['Credit_Card']!=NULL) echo $info3['Credit_Card']; else echo "Not Applied";?></td></tr>
	<tr><td>Cheque Book : </td><td><?php if($info3['ChequeBook']!=NULL) echo $info3['ChequeBook']; else echo "Not Applied";?></td></tr>
	<tr><td>Mobile Banking : </td><td><?php if($info3['Mobile_Banking']!=NULL) echo "Active On ".$info3['Mobile_Banking']; else echo "Not Applied";?></td></tr>
	<tr><td>Loans : </td>
		<td><ul><li><?php if($info3['Loan1']!=NULL) echo " <a href=\"Loan_Info.php?ln=$ln1\">".$info3['Loan1']."</a>"; else echo " Not Applied   ";?></li>
				<li><?php if($info3['Loan2']!=NULL) echo " <a href=\"Loan_Info.php?ln=$ln2\">".$info3['Loan2']."</a>"; else echo " Not Applied";?></li>
			</ul>
	</td></tr>
	<?php
}
