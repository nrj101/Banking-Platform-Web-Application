...
$query="SELECT * FROM loans ORDER BY AC_NO ASC LIMIT 30;";   
...
<div id="page" class="w3-container">
	...
	<div id="content" class="w3-container w3-col m12 l12 w3-center">
		<h2 align="center">Approved Loans</h2>
		<table title="Loan Applications" border=4 width="100%" align="center" style="background-color:#010; color:#fff;">
		
		<tr><th>LOAN_NO</th><th>AC_NO</th><th>NAME</th><th>CONTACT</th><th>DOA</th><th>LOAN TYPE</th><th>CITY</th><th>RES TYPE</th><th>EMP TYPE</th><th>AMOUNT (in Rs.)</th><th>AADHAAR</th></tr>

<?php
if(!$result)
{
	?>
	<h2 align="center">No Loans Approved Yet. </h2>
	</table>
	</div>
	<?php
}
