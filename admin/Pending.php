...
$query="SELECT * FROM ac_applications ORDER BY AC_NO ASC LIMIT 30;";   
$result=mysqli_query($con,$query);
?>
<!DOCTYPE html>
<html>
<head>
	<title>New A/C Applications</title>
...
<div id="page" class="w3-container">
	...
	<div id="content" class="w3-container w3-col m12 l12 w3-center">
		...
		<h2 align="center">Pending Application For New A/C</h2>
		<table title="Applications" border=4 width="100%" align="center" style="background-color:#010; color:#fff;">
		
		<tr> <th>ACTION 1</th><th>ACTION 2</th><th>FNAME</th><th>EMAIL</th><th>PHONE</th><th>DOB</th><th>DOJ</th><th>ADDRESS</th><th>AADHAAR</th><th>PAN</th></tr>
<?php
if(!$result)
{
	?>
	<h2 align="center">Zero A/C Applications pending for approval. </h2>
	<?php
}
else
{
