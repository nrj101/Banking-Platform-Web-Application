...
$query="SELECT * FROM KYC ORDER BY AC_NO ASC LIMIT 30";   
...
<div id="page" class="w3-container">
	...
	<div id="content" class="w3-container w3-col m12 l12 w3-center">
		<h2 align="center">Pending KYC Approval Requests</h2>
		<table title="KYC Data" border=4 width="100%" align="center" style="background-color:#010; color:#fff;" >
		
		<tr> <th>ACTION 1</th><th>ACTION 2</th><th>A/C NO.</th><th>NAME</th><th>DOB</th><th>ADDRESS</th><th>AADHAAR</th><th>PHOTO</th><th>SIGNATURE</th><th>ID</th></tr>
<?php
if(!$result)
{
	?>
	<h2 align="center">Zero KYC Applications pending for approval. </h2>
	<?php
}
else
{
	...
	{ 
		...
		<td class="w3-center w3-hover-green"> 
				<a href="KYC_Approval.php?ac=<?php echo $ac ?>&Approve=Approve" >
				<div >
		...
		<td class="w3-center w3-hover-green">    
				<a href="KYC_Approval.php?ac=<?php echo $ac ?>&Decline=Decline" >
				<div >
					<span class="w3-button w3-round-xlarge w3-medium w3-padding-large w3-green w3-hover-lime">Decline</span>
				</div></a>				
				<!--	<form action="KYC_Approval.php?ac=<?php echo $ac?>" method="POST" align="center" >
				<input name="Decline" value="Decline" type="submit">	</form>  -->
		</td>
		<td class="w3-center w3-hover-green">
				<a href="View_Ac_Direct.php?ac=<?php echo $ac?>" >
				<div >
					<span class="w3-button w3-round-xlarge w3-medium w3-padding-large w3-green w3-hover-lime"><?php echo $ac?></span>
				</div></a>
		</td>
		...
		<td><img src="../<?php  echo $info['Photo'] ?>" style="display:block;" height="60" width="80"  alt="Photo"/></td>
		<td><img src="../<?php  echo $info['Signature'] ?>" style="display:block;" height="40" width="100"  alt="Signature"/></td>
		<td><img src="../<?php  echo $info['ID'] ?>" style="display:block;" height="60" width="80"  alt="ID"/></td>
		<tr> 
		<?php
	}
}
