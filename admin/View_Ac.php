...
<head>
	...
	<style>
			...
			#content-form{ min-height: 420px; float:none;  padding-bottom:80px;}
...
?>	
	...
	<div id="content-form" class="w3-container w3-col m12 l12 w3-center simple-form">
		<form id="form-container" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
			<h2 class="form-name w3-bar">&nbsp;&nbsp;&nbsp;View Account&nbsp;&nbsp;&nbsp;</h2><br>
			<label>A/C No. : </label><input type="text" name="ac" maxLength="7" pattern="[1][0][1][0-9]{4}" title="Required Valid 7 digit A/C No." id="button" required placeholder="Enter Account Number"><br><br>
			<input type="submit" name="View" value="View" id="butt"><br><br><br><br>
		</form>
<?php
}
else
